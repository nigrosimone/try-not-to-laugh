...
`)}function xr(r){var t=r.shapeInfo.logicalShape;switch(t.length){case 0:return function(e){var n=e.name,o="get"+n.charAt(0).toUpperCase()+n.slice(1);if(e.shapeInfo.isUniform)return"float "+o+"() {return "+n+";}";var a=e.shapeInfo.texShape,i=a[0],s=a[1];if(i===1&&s===1)return`
      float `+o+`() {
  ...
  `}var c=En(n),l=c.newShape,f=c.keptDims,p=l;if(p.length<n.length){var h=br(e,p);return`
      `+xr(h)+`
      float `+a+`(int row, int col) {
        return `+a+"("+wr(["row","col"],f)+`);
      }
...
`}(r);case 3:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,a="get"+o.charAt(0).toUpperCase()+o.slice(1),i=n[1]*n[2],s=n[2],u=En(n),c=u.newShape,l=u.keptDims,f=c;if(f.length<n.length){var p=br(e,f);return`
        `+xr(p)+`
        float `+a+`(int row, int col, int depth) {
          return `+a+"("+wr(["row","col","depth"],l)+`);
        }
      `}if(e.shapeInfo.isUniform)return`
      float `+a+`(int row, int col, int depth) {
  ...
  `}(r);case 4:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,a="get"+o.charAt(0).toUpperCase()+o.slice(1),i=n[3],s=n[2]*i,u=n[1]*s,c=En(n),l=c.newShape,f=c.keptDims;if(l.length<n.length){var p=br(e,l);return`
      `+xr(p)+`
      float `+a+`(int row, int col, int depth, int depth2) {
        return `+a+"("+wr(["row","col","depth","depth2"],f)+`);
      }
    `}if(e.shapeInfo.isUniform)return`
      float `+a+`(int row, int col, int depth, int depth2) {
  ...
  `}(r);case 5:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,a="get"+o.charAt(0).toUpperCase()+o.slice(1),i=n[4],s=n[3]*i,u=n[2]*s,c=n[1]*u,l=En(n),f=l.newShape,p=l.keptDims;if(f.length<n.length){var h=br(e,f);return`
      `+xr(h)+`
      float `+a+`(int row, int col, int depth, int depth2, int depth3) {
        return `+a+"("+wr(["row","col","depth","depth2","depth3"],p)+`);
      }
    `}if(e.shapeInfo.isUniform)return`
      float `+a+`(int row, int col, int depth, int depth2, int depth3) {
        float index = dot(
  ...
  `}(r);case 6:return function(e){var n=e.shapeInfo.logicalShape,o=e.name,a="get"+o.charAt(0).toUpperCase()+o.slice(1),i=En(n),s=i.newShape,u=i.keptDims;if(s.length<n.length){var c=br(e,s);return`
      `+xr(c)+`
      float `+a+`(int row, int col, int depth,
                    int depth2, int depth3, int depth4) {
        return `+a+"("+wr(["row","col","depth","depth2","depth3","depth4"],u)+`);
      }
  ...
  `}(r);case 3:return function(o){var a=o.shapeInfo.logicalShape,i=o.name,s="get"+i.charAt(0).toUpperCase()+i.slice(1),u=o.shapeInfo.texShape,c=[Math.ceil(u[0]/2),Math.ceil(u[1]/2)];if(a[0]===1){var l=a.slice(1),f=br(o,l);return`
        `+Jl(f)+`
        vec4 `+s+`(int b, int row, int col) {
          return `+s+"("+wr(["b","row","col"],[1,2])+`);
        }
...
`,an=function(r,t,e,n){n===void 0&&(n=!1),this.variableNames=["A","B"],this.supportsBroadcasting=!0,this.packedInputs=!0,this.packedOutput=!0,this.outputShape=fe(t,e);var o=this.outputShape.length,a="";if(n)if(o===0||ee(this.outputShape)===1)a=`
    ...
    `},wv=function(r){this.variableNames=["A"],this.packedInputs=!0,this.packedOutput=!0,this.outPackingScheme=vo.DENSE;var t=co(r),e=st();this.outputShape=r,this.userCode=`
      ivec3 outCoordsFromFlatIndex(int index) {
        `+zn(["r","c","d"],r)+`
        return ivec3(r, c, d);
      }
...
`,Ef=`
  ...
  return result;
`,ao=function(r,t){this.variableNames=["A"],this.packedInputs=!0,this.packedOutput=!0,this.outputShape=r,this.userCode=`
